...
import { deletRegister, getFind, getLista, getListaPaginate, postGuardar } from '@/app/panel-control/services/configurations/tarifaService'
import type { Tarifa } from '@/app/panel-control/services/interface/Tarifa'
