...
import type { Categoria } from '@/app/panel-control/services/interface/Categorias'
import { deletRegister, getFind, getLista, postGuardar } from '@/app/panel-control/services/configurations/categoriaServices'
